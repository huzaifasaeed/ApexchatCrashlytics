...
public class MonoPackageManager_Resources {
	public static String[] Assemblies = new String[]{
		/* We need to ensure that "ApexchatCrashlytics.Android.dll" comes first in this list. */
		"ApexchatCrashlytics.Android.dll",
		"ApexchatCrashlytics.dll",
		"FormsViewGroup.dll",
		...
		"Xamarin.Android.Crashlytics.Answers.dll",
		"Xamarin.Android.Crashlytics.Beta.dll",
		"Xamarin.Android.Crashlytics.Core.dll",
		"Xamarin.Android.Crashlytics.dll",
